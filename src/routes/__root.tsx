...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get Top Rated SEO Tools from a vendor you can count on." },
      { property: "og:description", content: "Get Top Rated SEO Tools from a vendor you can count on." },
      { name: "twitter:description", content: "Get Top Rated SEO Tools from a vendor you can count on." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5c608189-9691-49ce-a96f-f4860319b0eb/id-preview-216854a3--4f4632d6-30e9-428a-b31e-ec81b5b680a6.lovable.app-1784266635135.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5c608189-9691-49ce-a96f-f4860319b0eb/id-preview-216854a3--4f4632d6-30e9-428a-b31e-ec81b5b680a6.lovable.app-1784266635135.png" },
    ],
    links: [

...
assert(
  !accepts(
    "https://evil.example/auth/v1/verify?type=magiclink&redirect_to=https%3A%2F%2Fsneakwrite.net%2Fapp",
  ),
  "rejects an untrusted launch host",
);
assert(
  !accepts(
    "https://rsnxhzlqxivpnpryzesu.supabase.co/auth/v1/token?type=magiclink&redirect_to=https%3A%2F%2Fsneakwrite.net%2Fapp",
  ),
  "rejects an unexpected Supabase auth path",
);
assert(
  !accepts(
    "https://rsnxhzlqxivpnpryzesu.supabase.co/auth/v1/verify?type=recovery&redirect_to=https%3A%2F%2Fsneakwrite.net%2Fapp",
  ),
  "rejects non-magic-link handoffs",
);
assert(
  !accepts(
    "https://rsnxhzlqxivpnpryzesu.supabase.co/auth/v1/verify?type=magiclink&redirect_to=https%3A%2F%2Fevil.example%2Fapp",
  ),
  "rejects redirects away from SneakWrite",
);
assert(
  !accepts(
    "https://rsnxhzlqxivpnpryzesu.supabase.co/auth/v1/verify?type=magiclink&redirect_to=https%3A%2F%2Fsneakwrite.net%2Flogin",
  ),
